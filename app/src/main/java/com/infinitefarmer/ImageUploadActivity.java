        ...
        switch (v.getId()) {
            ...
            case R.id.uploadButton:
                ...
                try {
                    ...
                    jsonObject.put(Utils.farmer,"dbjd");
                    jsonObject.put(Utils.health,"0");
                    jsonObject.put(Utils.phone,PrefManager.getPhone(ImageUploadActivity.this));
                ...
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Utils.urlUpload, jsonObject,
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject jsonObject) {
                                ...
                                startActivity(new Intent(ImageUploadActivity.this,BidActivity.class));
                            }
